# SpringBrand Codex single-client installation
...
This document configures **Codex only**. Do not detect, configure, update, or remove any other client. Preserve every unrelated configuration and existing MCP entry.
