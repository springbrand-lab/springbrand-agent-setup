# SpringBrand Dev Claude Code single-client installation
...
This document targets immutable development release `v1.2.1-dev.2`. It configures **Claude Code only**. Do not detect, configure, update, or remove any other client. Preserve every unrelated configuration and existing MCP entry.
...
```sh
npx -y @springbrand/cli@alpha connect claude-code --url https://devconnector.springbrand.ai/mcp --api-key {{INSTALL_KEY}}
```
