# SpringBrand OpenCode single-client installation
...
This document configures **OpenCode only**. Do not detect, configure, update, or remove any other client. Preserve every unrelated configuration and existing MCP entry.
...
```sh
npx -y @springbrand/cli@latest connect opencode --url https://connector.springbrand.ai/mcp --api-key {{INSTALL_KEY}}
```
