...
```text
Skill URLs:
  https://raw.githubusercontent.com/springbrand-lab/springbrand-agent-setup/v1.2.0-beta.7-dev.3/skills/ask-springbrand/SKILL.md
  https://raw.githubusercontent.com/springbrand-lab/springbrand-agent-setup/v1.2.0-beta.7-dev.3/skills/springbrand-platform/SKILL.md
  https://raw.githubusercontent.com/springbrand-lab/springbrand-agent-setup/v1.2.0-beta.7-dev.3/skills/springbrand-action-api/SKILL.md
  https://raw.githubusercontent.com/springbrand-lab/springbrand-agent-setup/v1.2.0-beta.7-dev.3/skills/springbrand-connector/SKILL.md
MCP URL:
...
| Version | `1.2.0-beta.7-dev.3` |
| Git ref | `v1.2.0-beta.7-dev.3` |
...
```sh
codex plugin marketplace add springbrand-lab/springbrand-agent-setup --ref v1.2.0-beta.7-dev.3
...
```sh
claude plugin marketplace add springbrand-lab/springbrand-agent-setup@v1.2.0-beta.7-dev.3 --scope user
...
```text
springbrand-lab/springbrand-agent-setup@v1.2.0-beta.7-dev.3
```
...
```text
https://github.com/springbrand-lab/springbrand-agent-setup/archive/refs/tags/v1.2.0-beta.7-dev.3.zip
```
...
- Plugin ID `springbrand-dev` and version `1.2.0-beta.7-dev.3`;
