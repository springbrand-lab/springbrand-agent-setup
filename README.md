...
The native development Plugin is the immutable prerelease [`v1.2.0-beta.6-dev.2`](https://github.com/springbrand-lab/springbrand-agent-setup/releases/tag/v1.2.0-beta.6-dev.2). It is identified as `springbrand-dev`, displays as **SpringBrand Dev**, and bundles one `springbrand-dev` MCP server at `https://devconnector.springbrand.ai/mcp`. Authentication is host-native OAuth.
...
| Development | `springbrand-lab/springbrand-agent-setup@v1.2.0-beta.6-dev.2` |
