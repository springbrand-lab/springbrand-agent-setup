...
> https://github.com/springbrand-lab/springbrand-agent-setup/blob/v1.2.2-dev.1/INSTALL.dev.md
...
| Development | `springbrand-lab/springbrand-agent-setup@v1.2.2-dev.1` |
