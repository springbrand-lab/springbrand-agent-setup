...
SKILL_PHRASES = {
    ...
    "springbrand-platform": (
        ...
        "Do not skip a fitting Plugin merely because it is not added.",
        "without asking for separate user confirmation",
        "**Paid and already entitled:**",
        "**Paid and not entitled:**",
        "**Unknown cost:**",
        "user_state: added",
        "do not bypass a Host-enforced approval",
        "Free Plugin addition does not imply",
